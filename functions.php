...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('hero-small', 2700, 500, true);
	...
	add_image_size('work-thumb', 300, 200, true);
	add_image_size('team', 440, 560, true);
	add_image_size('single-work', 720, 480, true);
	add_image_size('work-gallery', 1440, 1000, true);
	add_image_size('about', 720, 480, true);
...
function hackeryou_scripts() {
  ...
  // Bx-slider
  wp_enqueue_script( 'bxslider-js-js', get_template_directory_uri() . "/js/bxslider/jquery.bxslider.min.js", array( 'jquery' ), '1.5.9', true );
   wp_enqueue_script( 'bxslider-js-js', get_template_directory_uri() . "/js/bxslider/jquery.bxslider.js", array( 'jquery' ), '1.5.9', true );
   wp_enqueue_style( 'bxslider-js-style', get_stylesheet_directory_uri() . '/js/bxslider/jquery.bxslider.css', array(), '1.5.9' );
   wp_enqueue_style( 'bxslider-js-style', get_stylesheet_directory_uri() . '/js/bxslider/jquery.bxslider.min.css', array(), '1.5.9' );
